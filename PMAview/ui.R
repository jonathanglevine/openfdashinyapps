...
getallvars <- function()
{
  vars <- c( 'Any Variable', getPMAdevicevars(), getapplicantvars(), paste0( 'openfda.', getopenfdavars() ) )
  return(vars)
}
...
fluidRow(
  ...
  column(width=9, 
      ...
      tabsetPanel(
                ...
                tabPanel('Data Reference', HTML( renderiframe( "https://open.fda.gov/device/pma/") ) 
                ),
                tabPanel('About', 
