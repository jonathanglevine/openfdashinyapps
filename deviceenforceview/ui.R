...
shinyUI(fluidPage(
                  fluidRow(
                    column(width=4,
                           a(href='https://open.fda.gov/device/event/reference', 
                             img(src='l_openFDA.png', align='bottom'))
                           ,
                           renderDates()
                    ),
                    column(width=8,
                           titlePanel("Device Enforcement Browser" ) )
                  ),
  fluidRow(
...
fluidRow(
  ...
  column(width=9, 
      ...
      tabsetPanel(
                ...
                tabPanel('Data Reference', HTML( renderiframe( "https://open.fda.gov/device/enforcement/") ) 
                ),
                tabPanel('About', 
